...
import { XCircle, ChevronRight, X, AlertTriangle, ShieldAlert, CreditCard, Calendar } from 'lucide-react';
...
export default function PaymentFailurePage() {
  ...
  useEffect(() => {
    ...
    // Fetch last attempted order from sessionStorage
        ...
        <main className="flex-1 overflow-y-auto flex flex-col justify-between">
          <div className="px-4 sm:px-8 py-6 sm:py-12 w-full max-w-[500px] mx-auto flex-grow flex flex-col justify-center relative z-10">
            ...
            <div className="bg-white rounded-[2rem] p-8 sm:p-10 shadow-xl shadow-zinc-200/50 text-center border border-zinc-100" data-aos="fade-up" data-aos-duration="800">
              ...
              {/* Failure Icon */}
              <div className="h-24 w-24 bg-rose-50 rounded-full flex items-center justify-center mx-auto mb-6 border-8 border-rose-50/50">
                <img 
              ...
              {/* Headings */}
              <h1 className="text-2xl sm:text-[28px] font-bold text-[#1a202c] tracking-tight mb-2">Payment Failed</h1>
              ...
              <div className="space-y-4 text-left mb-10">
                <div className="flex justify-between items-center">
                  <span className="text-[15px] font-medium text-[#a0aec0]">Attempted ID</span>
