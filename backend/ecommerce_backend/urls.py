...
from shop.views import (
    ProductViewSet, MainCategoryViewSet, CategoryViewSet, SubCategoryViewSet, OrderViewSet, PaymentViewSet,
...
router.register(r'mobile-banners', MobileBannerViewSet, basename='mobile-banner')
